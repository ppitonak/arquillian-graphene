...
public class ReusableRemoteWebDriverExtension {
    ...
    public static final File DEFAULT_FILE = new File(System.getProperty("user.home"), ".graphene-driver-session-store");
    ...
    public void initializeParamsMap(@Observes BeforeSuite event) {
        initParamsMapInstance.set(new InitializationParametersMap());
    }
